...
class RobomimicGymWrapper(Wrapper, gym.Env):
    metadata = None
    render_mode = None
    """
    ...
    def __init__(self, env, keys=None, horizon = 1000):
        # Run super method
        super().__init__(env=env)
        self.horizon = horizon # maximum number of steps in an episode
        ...
        if keys is None:
            ...
            for idx in range(len(self.env.robots)):
                ...
                keys += ["robot{}_eef_pos".format(idx), "robot{}_eef_quat".format(idx), "robot{}_gripper_qpos".format(idx)]
        self.keys = keys
        print("keys: ", keys)
