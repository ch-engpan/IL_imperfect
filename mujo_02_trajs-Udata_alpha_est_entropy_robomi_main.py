...
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 0 --uu_seed 0 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 0 --uu_seed 1 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 0 --uu_seed 2 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 0 --uu_seed 3 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 0 --uu_seed 4 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",


"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 0 --uu_seed 0 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 0 --uu_seed 1 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 0 --uu_seed 2 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 0 --uu_seed 3 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 0 --uu_seed 4 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",




"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 1 --uu_seed 0 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 1 --uu_seed 1 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 1 --uu_seed 2 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 1 --uu_seed 3 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 1 --uu_seed 4 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",


"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 1 --uu_seed 0 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 1 --uu_seed 1 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 1 --uu_seed 2 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 1 --uu_seed 3 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 1 --uu_seed 4 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",




"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 2 --uu_seed 0 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 2 --uu_seed 1 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 2 --uu_seed 2 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 2 --uu_seed 3 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 2 --uu_seed 4 --method 5 --Pi_range_select 0  --pi_given False  --exp_check_num 5",



"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 2 --uu_seed 0 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 2 --uu_seed 1 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 2 --uu_seed 2 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 2 --uu_seed 3 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",
"python mujo_02_trajs-Udata_alpha_est_entropy_robomi_main.py   --env 2 --uu_seed 4 --method 5 --Pi_range_select 1  --pi_given False  --exp_check_num 5",
...
parser.add_argument('--exp_check_num', type=int, default='3', help='number of samples to check by experts')
# pi_test
...
data_path = "/home/robo/Projects/p3/robomimic/datasets/"+ env_name +"/mh/low_dim_v15.hdf5"
...
def load_operator_demos(hdf5_path, operator_masks=None):
    if operator_masks is None:
        operator_masks = [
            "better_operator_1", "better_operator_2",
            "okay_operator_1", "okay_operator_2",
            "worse_operator_1", "worse_operator_2"
        ]

    def load_item(item):
        """Load either an HDF5 dataset or a group (recursively)."""
        if isinstance(item, h5py.Dataset):
            return item[()]                    # load numpy array
        elif isinstance(item, h5py.Group):
            return {k: load_item(item[k]) for k in item.keys()}  # recursive
        else:
            raise TypeError("Unknown HDF5 item type")

    demos_by_operator = {}

    with h5py.File(hdf5_path, "r") as f:
        mask_group = f["mask"]
        print("Available mask keys:", list(mask_group.keys()))

        for mask_key in operator_masks:
            demo_names_bytes = mask_group[mask_key][()]
            demo_names = [
                name.decode("utf-8") if isinstance(name, bytes) else str(name)
                for name in demo_names_bytes
            ]
            ...
            for demo_name in demo_names:
                ...
                for key in demo_group.keys():
                    demo_dict[key] = load_item(demo_group[key])
                demos.append(demo_dict)

            demos_by_operator[mask_key] = demos

    return demos_by_operator
...
print("Loading operator demos from: ", data_path)
operator_demos = load_operator_demos(data_path, operator_masks=operator_masks)

# Access better_operator_1 demos

print("Number of better_operator_1 demos:", len(operator_demos["better_operator_1"]))
# better_operator_2
print("Number of better_operator_2 demos:", len(operator_demos["better_operator_2"]))
print("First demo keys:", operator_demos["better_operator_1"][0].keys())    
print("First demo 'actions' shape:", operator_demos["better_operator_1"][0]["actions"].shape)
print("First demo 'states' shape:", operator_demos["better_operator_1"][0]["states"].shape)
print("First demo 'obs' shape:", operator_demos["better_operator_1"][0]["obs"].keys())

def build_opt_nonopt_sets_flat(demos_by_operator):
    # Operator grouping
    opt_keys = ["better_operator_1", "better_operator_2"]
    nonopt_keys = ["worse_operator_1", "worse_operator_2"]
    ...
    # --- Optimal ---
    for key in opt_keys:
        for demo in demos_by_operator[key]:
            s, a = extract_sa(demo)
            opt_s_list.append(s)
            opt_a_list.append(a)
            all_states.append(s)
    ...
    # --- Non-optimal ---
    for key in nonopt_keys:
        for demo in demos_by_operator[key]:
            s, a = extract_sa(demo)
            nonopt_s_list.append(s)
            nonopt_a_list.append(a)
            all_states.append(s)
            all_actions.append(a)

    # --- Flatten ---
    opt_s = np.vstack(opt_s_list)              # (N_opt, s_dim)
    opt_a = np.vstack(opt_a_list)              # (N_opt, a_dim)
    nonopt_s = np.vstack(nonopt_s_list)        # (N_nonopt, s_dim)
    nonopt_a = np.vstack(nonopt_a_list)        # (N_nonopt, a_dim)


    # --- Add middle dimension using reshape ---
    opt_s = opt_s.reshape(opt_s.shape[0], 1, opt_s.shape[1])
    opt_a = opt_a.reshape(opt_a.shape[0], 1, opt_a.shape[1])
    nonopt_s = nonopt_s.reshape(nonopt_s.shape[0], 1, nonopt_s.shape[1])
    nonopt_a = nonopt_a.reshape(nonopt_a.shape[0], 1, nonopt_a.shape[1])
    ...
    s_min = np.min(all_states_flat, axis=0)
    s_max = np.max(all_states_flat, axis=0)
    a_min = np.min(all_actions_flat, axis=0)
    a_max = np.max(all_actions_flat, axis=0)

    # (2, s_dim) and (2, a_dim)
    s_maxmin = np.vstack([s_max, s_min])
    a_maxmin = np.vstack([a_max, a_min])



    return opt_s, opt_a, nonopt_s, nonopt_a, s_maxmin, a_maxmin


opt_traj_s_set, opt_traj_a_set, nonopt_traj_s_set, nonopt_traj_a_set, s_maxmin, a_maxmin = build_opt_nonopt_sets_flat(operator_demos)

print("Optimal trajectories shape:", opt_traj_s_set.shape)
print("Non-optimal trajectories shape:", nonopt_traj_s_set.shape)

print("State scaler input shape:", s_maxmin.shape)
print("Action scaler input shape:", a_maxmin.shape)


opt_start_steps = 200

print("opt_traj_s_set shape", np.array(opt_traj_s_set).shape)
print("opt_traj_a_set shape", np.array(opt_traj_a_set).shape)
print("nonopt_traj_s_set shape", np.array(nonopt_traj_s_set).shape)
print("nonopt_traj_a_set shape", np.array(nonopt_traj_a_set).shape)
print("s_maxmin: ", s_maxmin.shape, " a_maxmin: ", a_maxmin.shape)
print("opt_start_steps: ", opt_start_steps)
