...
" python3 mujo_10_gail_paral.py  --Expert_idx 0  --total_steps 3e6  --env 0  --noisy False --data_augm both   --rl_seed 2  --Pi_range_select 0 ",
...
def main(args):
    ...
    if clean_data:
        models_dir = root_folder + "/logs_gails_clean/"
    else:
        models_dir = root_folder + "/logs_gails_noisy/"
    ...
    if not clean_data:
        save_dir = models_dir+env_name+"_GAIL_"+RL_alg+"_NetAgentSeed_" + str(expert_idxs[0]) + "-" + str(expert_idxs[-1])+"_RLseed_"+str(seed_value)+"_gail_discrm_"+str(scoring_update_itrs)+"_iters"+"_noisy-un"+suffix+"/"

    else:
        save_dir = models_dir+env_name+"_GAIL_"+RL_alg+"_NetAgentSeed_" + str(expert_idxs[0]) + "-" + str(expert_idxs[-1])+"_RLseed_"+str(seed_value)+"_gail_discrm_"+str(scoring_update_itrs)+"_iters"+"-un"+suffix+"/"
